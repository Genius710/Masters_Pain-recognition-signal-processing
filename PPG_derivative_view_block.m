...
load('D:\OneDrive - Kaunas University of Technology\MAGISTRINIS\Data\Aurimod01PPGBlockECG_y_org_v3.mat')
...
%     signal = Data.PPG(:,2);
%     time = Data.Time_PPG
% signal = [Input(100,1:100),Input(101,1:100)];
signal = [zeros(1,50),Input(100,1:100),zeros(1,50)];
    time = 1:200
