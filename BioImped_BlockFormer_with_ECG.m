...
%         figure(2)
%       plot(Input(:,104));
%      save(strcat('D:\OneDrive - Kaunas University of Technology\MAGISTRINIS\Data\Aurimod',num,'BioImpedBlockECG1_v2_lp_5hz.mat'),'Input', 'Label','NPRS','NPRST');
%          clear Input;
%          clear Label;
%          clear NPRS;
%          clear NPRST;
...
save(strcat('D:\OneDrive - Kaunas University of Technology\MAGISTRINIS\IPD_E_v2.mat'),'E');   