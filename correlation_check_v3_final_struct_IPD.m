...
load(strcat('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\Data\Aurimod',num,'IPD_Final_Struct.mat'))
%      end
...
%      Blocks.PhaseTime.WarmWater.Start = 600;
     ...
     lim = find([Blocks.Blocks(:).PainTime] > 240)
     star = find([Blocks.Blocks(:).PainTime] > 120)
...
%      end
 ...
 save(strcat('C:\OneDrive - Kaunas University of Technology\MAGISTRINIS\Data\Aurimod',num,'IPD_Final_Struct.mat'), 'Blocks')
