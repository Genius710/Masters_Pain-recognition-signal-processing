...
BlockPPG(iii).Signal = zeros(1,100)
...
%             count1 = count1+1;
        if A(iii).NPRST(yyy) < C(iii).PhaseTime.WarmWater.Start % baseline
            BlockPPG(1).Signal(count1,:) = A(iii).Input(yyy,1:100); 
            count1 = count1+1;
        elseif A(iii).NPRST(yyy) < C(iii).PhaseTime.ColdWater7C.Start %warm water
            BlockPPG(2).Signal(count2,:) = A(iii).Input(yyy,1:100); 
            count2 = count2+1;
        elseif A(iii).NPRST(yyy) < C(iii).PhaseTime.ColdWater7C.End % cold water 7c
            BlockPPG(3).Signal(count3,:) = A(iii).Input(yyy,1:100);
            count3 = count3+1;
        elseif A(iii).NPRST(yyy) < C(iii).PhaseTime.ColdWater10C.Start % recovery1
            BlockPPG(4).Signal(count4,:) = A(iii).Input(yyy,1:100);
            count4 = count4+1;
        elseif A(iii).NPRST(yyy) < C(iii).PhaseTime.ColdWater10C.End % cold water 10c
            BlockPPG(5).Signal(count5,:) = A(iii).Input(yyy,1:100);
            count5 = count5+1;
        elseif A(iii).NPRST(yyy) < C(iii).PhaseTime.DeepBreathing.Start % recovery 2
            BlockPPG(6).Signal(count6,:) = A(iii).Input(yyy,1:100);
            count6 = count6+1;
        elseif A(iii).NPRST(yyy) < C(iii).PhaseTime.DeepBreathing.End % deep breathing
            BlockPPG(7).Signal(count7,:) = A(iii).Input(yyy,1:100);
            count7 = count7+1;
        else
            BlockPPG(8).Signal(count8,:) = A(iii).Input(yyy,1:100);
            count8 = count8+1;
        end
    end
